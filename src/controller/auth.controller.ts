...
import { sendVerificationCode, sendPasswordResetLink } from "../utils/sendVerificationEmail.js";
...
export const signup = async (req: Request, res: Response) => {
  ...
  try {
    ...
    try {
      ...
      res.status(201).json({ message: "Signup successful. Please check your email for a verification code." });
    } catch (emailError) {
...
export const verifyEmail = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Email verified successfully.", accessToken, refreshToken });
...
export const resendVerificationCode = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(500).json({ message: "Something went wrong while resending the verification code." });
  }
};
...
export const resetPassword = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(200).json({ message: 'Password has been reset successfully.', accessToken, refreshToken });
